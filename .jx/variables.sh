...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-gitops/main/118'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-gitops:1.4.19'
