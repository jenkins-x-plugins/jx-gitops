...
const (
	// RequirementsValuesFileName is the name of the helm values.yaml configuration file for common JayeX values
...
# For more information see: https://jayex.io/v3/develop/apps/#using-requirements-in-charts
`
